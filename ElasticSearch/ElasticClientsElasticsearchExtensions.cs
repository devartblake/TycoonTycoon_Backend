...
namespace Microsoft.Extensions.Hosting
{
    public static class AspireElasticClientsElasticsearchExtensions
    {
        ...
        public static void AddElasticClientsElasticsearch(this IHostApplicationBuilder builder, string connectionName, Action<ElasticClientsElasticsearchSettings>? configureSettings = null, Action<ElasticsearchClientSettings>? configureClientSettings = null) =>
        ...
        /// <exception cref="InvalidOperationException">Thrown when mandatory <see cref="ElasticClientsElasticsearchSettings.ConnectionString"/> is not provided.</exception>
        /// <exception cref="InvalidOperationException">Thrown when mandatory <see cref="ElasticClientsElasticsearchSettings.Cloud"/> is not provided and <see cref="ElasticClientsElasticsearchSettings.UseCloud" /> is true .</exception>
        public static void AddKeyedElasticClientsElasticsearch(this IHostApplicationBuilder builder, string name, Action<ElasticClientsElasticsearchSettings>? configureSettings = null, Action<ElasticsearchClientSettings>? configureClientSettings = null)
        {
        ...
        private static void AddElasticClientsElasticsearch(this IHostApplicationBuilder builder, string configurationSectionName, Action<ElasticClientsElasticsearchSettings>? configureSettings, Action<ElasticsearchClientSettings>? configureClientSettings, string connectionName, object? serviceKey)
        {
        ...
        private static ElasticsearchClientSettings CreateElasticsearchClientSettings(ElasticClientsElasticsearchSettings settings, string connectionName, string configurationSectionName)
        {
