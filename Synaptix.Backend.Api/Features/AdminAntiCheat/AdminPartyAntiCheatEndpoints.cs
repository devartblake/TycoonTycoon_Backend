...
namespace Synaptix.Backend.Api.Features.AdminAntiCheat
{
    public static class AdminPartyAntiCheatEndpoints
    {
        public static void Map(IEndpointRouteBuilder admin)
        {
                ...
                CancellationToken ct) =>
            {
                ...
                if (flag is null)
                    return ApiResponses.Error(StatusCodes.Status404NotFound, "NOT_FOUND", "Party anti-cheat flag not found.");
