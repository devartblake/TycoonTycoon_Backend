...
namespace Synaptix.Hosting.Elasticsearch
{
    /// <summary>
            ...
            IResourceWithConnectionString
    {
        ...
        public ElasticsearchResource(string name, ParameterResource password)
            : base(name)
        {
        ...
        private EndpointReference? internalEndpoint;
        ...
        public EndpointReference InternalEndpoint =>
            this.internalEndpoint ??= new(this, InternalEndpointName);
        ...
        public ReferenceExpression ConnectionStringExpression =>
            ReferenceExpression.Create(
                $"http://{UserName}:{this.PasswordParameter}@{this.PrimaryEndpoint.Property(EndpointProperty.Host)}:{this.PrimaryEndpoint.Property(EndpointProperty.Port)}"
            );
    }
}