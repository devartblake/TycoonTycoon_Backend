...
namespace Synaptix.Backend.Application.Study
{
    internal static class StudySetHelpers
    {
        ...
        public static IQueryable<Synaptix.Backend.Domain.Entities.Question> BuildApprovedQuestionsQuery(
            IAppDb db,
        ...
        public static IQueryable<Synaptix.Backend.Domain.Entities.Question> BuildCategoryCountsQuery(IAppDb db)
        {
