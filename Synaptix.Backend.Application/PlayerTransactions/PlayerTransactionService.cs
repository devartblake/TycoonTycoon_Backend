...
namespace Synaptix.Backend.Application.PlayerTransactions
{
    public sealed class PlayerTransactionService
    {
        private readonly IAppDb _db;
        private readonly EconomyService _econ;

        public PlayerTransactionService(IAppDb db, EconomyService econ)
        {
            _db = db;
            _econ = econ;
        }
