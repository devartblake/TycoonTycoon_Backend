...
- Added recurring notification dispatch job with retry/failure state transitions.
- Remaining hardening work is focused on stronger JWT scope policies, abuse controls, and observability depth.
