...
public sealed class StoreStripePaymentEndpointsTests : IClassFixture<SynaptixApiFactory>
{
    private readonly SynaptixApiFactory _factory;

    public StoreStripePaymentEndpointsTests(SynaptixApiFactory factory)
    {
        _factory = factory;
    }
