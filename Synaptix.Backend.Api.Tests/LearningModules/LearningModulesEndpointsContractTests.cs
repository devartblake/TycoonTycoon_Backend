...
public sealed class LearningModulesEndpointsContractTests : IClassFixture<SynaptixApiFactory>
{
    ...
    public LearningModulesEndpointsContractTests(SynaptixApiFactory factory)
    {
        _factory = factory;
