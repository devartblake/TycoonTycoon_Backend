...
namespace Synaptix.MigrationService.Persistence;
...
public sealed class DesignTimeAppDbFactory : IDesignTimeDbContextFactory<AppDb>
{
    public AppDb CreateDbContext(string[] args)
    {
        ...
        var options = new DbContextOptionsBuilder<AppDb>()
            .UseNpgsql(cs, npgsql =>
            {
                // Migrations always live in Synaptix.Backend.Migrations — single source of truth.
                npgsql.MigrationsAssembly("Synaptix.Backend.Migrations");
            })
