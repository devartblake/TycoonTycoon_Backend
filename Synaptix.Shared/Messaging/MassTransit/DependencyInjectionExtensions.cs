...
using Synaptix.Shared.Core.Messaging;
using System.Reflection;

namespace Synaptix.Shared.Messaging.MassTransit
{
    public static class DependencyInjectionExtensions
    {
        ...
        private static void ConfigRabbitMQBroker(MessagingOptions messagingOptions, IBusRegistrationConfigurator busRegistrationConfigurator)
        {
