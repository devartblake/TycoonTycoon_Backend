using Mediator;
using Synaptix.Shared.Observability.CoreDiagnostics.Commands;
using Synaptix.Shared.Observability.CoreDiagnostics.Query;
using IBaseCommand =Synaptix.Shared.Abstractions.Core.CQRS.IBaseCommand;
using IBaseQuery =Synaptix.Shared.Abstractions.Core.CQRS.IBaseQuery;

namespace Synaptix.Shared.Observability.Behaviors;
