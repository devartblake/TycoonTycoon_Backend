...
The Vue + ASP.NET Web BFF approach (this project + `Tycoon.OperatorDashboard.Vue`) was
superseded by `Tycoon.OperatorDashboard.Django`, which is now the default operator
