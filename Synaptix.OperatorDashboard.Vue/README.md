# Synaptix.OperatorDashboard.Vue — Deprecated

This project is no longer an active Operator Dashboard migration target.

`Synaptix.OperatorDashboard.Django` is the canonical operator dashboard for all admin/operator roles. Do not add new operator workflows, role splits, or cutover work to this Vue project.
...
- `Synaptix.OperatorDashboard.Vue/DEPRECATED.md`
