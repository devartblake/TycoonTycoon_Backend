...
{
    /// <inheritdoc />
    public partial class AddGameEventTables : Migration
    {
        /// <inheritdoc />
        ...
        {
            migrationBuilder.DropTable(name: "game_event_participants");
            migrationBuilder.DropTable(name: "game_event_prize_claims");
            migrationBuilder.DropTable(name: "game_events");
            migrationBuilder.DropTable(name: "guardian_challenges");
            migrationBuilder.DropTable(name: "territory_duels");
            migrationBuilder.DropTable(name: "territory_tiles");
            migrationBuilder.DropTable(name: "tier_guardians");
