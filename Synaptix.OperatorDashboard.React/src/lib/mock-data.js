 ...
 */
// ============ Users Mock Data ============
export function generateMockUsers(count = 20) {
...
export const MOCK_DEAD_LETTERS = [
    {
        id: 'dl_1',
        templateId: 'tpl_1',
        templateName: 'Welcome Email',
...
export function generateMockAntiCheatFlag(id = 'flag_1') {
    const reasons = [
    ...
    return {
        ...
        flagSeverity: ['low', 'medium', 'high', 'critical'][Math.floor(Math.random() * 4)],
...
export const MOCK_ANTI_CHEAT_STATS = {
    pendingCount: 12,
    reviewedThisWeek: 89,
    completionRate: 0.92,
};
