...
class HealthCheckClient {
     ...
     */
    extractMetric(_data, _metricName, fallback) {
        try {
     ...
     */
    getStatusColor(isHealthy, usage) {
        if (isHealthy === false) {
...
export const healthCheckClient = new HealthCheckClient(import.meta.env.VITE_HEALTH_CHECK_BASE_URL ||
