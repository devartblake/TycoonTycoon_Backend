...
export default function PlayerProfilePage() {
    ...
    return (_jsxs("div", { className: "operator-container space-y-6", children: [_jsx("div", { className: "flex items-center justify-between", children: _jsxs("div", { children: [_jsx("button", { onClick: () => navigate(-1), className: "text-accent hover:underline text-sm mb-2", children: "\u2190 Back" }), _jsx("h1", { className: "text-2xl font-bold text-ink-primary", children: "Player Moderation" })] }) }), successMessage && (_jsxs("div", { className: "p-4 bg-status-healthy/10 border border-status-healthy/20 rounded text-status-healthy text-sm", children: ["\u2713 ", successMessage] })), moderation && (_jsx(PlayerHeader, { profile: moderation.profile, isLoading: isLoading })), _jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-6", children: [_jsx("div", { children: moderation && (_jsx(ActionPanel, { profile: moderation.profile, onBan: handleBan, onUnban: handleUnban, onSuspend: handleSuspend, onUnsuspend: handleUnsuspend, onWarn: handleWarn, isLoading: isMutating })) }), _jsxs("div", { className: "lg:col-span-2 space-y-6", children: [moderation && (_jsx(ActionHistory, { actions: moderation.actions, isLoading: isLoading })), moderation && (_jsx(ActivityTimeline, { activities: moderation.activity, isLoading: isLoading }))] })] })] }));
}
