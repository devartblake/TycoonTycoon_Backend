...
export default function ResetPasswordPage() {
    ...
    if (isValidating) {
        return (_jsx(ErrorBoundary, { children: _jsx("div", { className: "space-y-4 text-center", children: _jsx("h2", { className: "text-2xl font-bold text-ink-primary", children: "Validating reset link..." }) }) }));
    }
    if (tokenError) {
